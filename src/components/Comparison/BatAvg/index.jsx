...
export default class index extends Component {
    ...
    render() {
        ...
        this.state.playersdata.map(d => {
            if(d.strike_rate > maxValue){
                maxValue = d.strike_rate;
            }
        });
        ...
        return ( 
            <Card>
            <Card.Header><center><h5>Batting Average
                <span style={{color:"#6cb313"}}>&nbsp;&#9635;&nbsp;</span>
                & Strike Average
                <span style={{color:"#085aa2"}}>&nbsp;&#9635;&nbsp;</span>
                </h5></center></Card.Header>
            <Row>
            
            {/* Creating Svg for Chart */}
            <svg style={{marginLeft: "auto", marginRight: "auto",  minWidth: '350px', maxWidth: '1500px', minHeight: '600px', width: '100%', height:'100%'}}>
